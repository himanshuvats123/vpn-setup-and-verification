...
2️⃣ Install VPN Client
Downloaded and installed the ProtonVPN desktop application.

3️⃣ Connect to VPN Server
Connected to the nearest available VPN server using the **Quick Connect** option.

4️⃣ Verify IP Address Change
Checked IP address before and after connecting to VPN using an online IP checker.

5️⃣ Test Secure Browsing
Accessed websites to confirm normal browsing functionality while connected.
